...
const UserWidget = ({ userId, picturePath }) => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      switch (dialogType) {
        case "resume":
          url = "http://192.168.60.254:3001/api/updateResumeLink";
          setResumeLink(tempLink);
          break;
        case "portfolio":
          url = "http://192.168.60.254:3001/api/updatePortfolioLink";
          setPortfolioLink(tempLink);
          break;
        case "phonenumber":
          url = "http://192.168.60.254:3001/api/updatePhoneNumber";
          setPhoneNumber(tempLink);
          break;
        case "linkedin":
          url = "http://192.168.60.254:3001/api/updateLinkedInLink";
  ...
  const getUser = async () => {
    try {
      const response = await fetch(`http://192.168.60.254:3001/users/${userId}`, {
        method: "GET",
